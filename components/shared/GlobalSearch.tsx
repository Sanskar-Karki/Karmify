...
import {
  ...
  ShoppingCart, TrendingUp, Settings, Users, CornerDownLeft,
} from "lucide-react";
                ...
                {group.items.map(item => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-5 py-3 mx-2 rounded-xl text-left transition-all cursor-pointer ${idx === activeIdx ? "bg-gradient-to-r from-primary/20 to-primary/10 border border-primary/30 shadow-md" : "hover:bg-muted/50"}`}
                    >
